...
<html lang="en">
    ...
    <head>
        ...
        <title>Login | Blockchain City</title>
        <link
        ...
        <link
            href="/css/select2.min.css?_<?=time()?>"
            rel="stylesheet"/>
    ...
    <body class="body-login" style="background-color:#000001;background: url('/img/wallpapers.jpg') no-repeat;background:cover">
