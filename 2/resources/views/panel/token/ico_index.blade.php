...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Tokens ICO  <a href="{{ url('/tokens/ico/create') }}" class="btn btn-primary btn-xs" title="Add New Token">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <table id="tokenstable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th width="5%" style="text-align:center">Token ID</th>
                            ...
                            @foreach($tokens as $item)
                                <tr>
                                    ...
                                    @endif
                                    <a href="{{ url('/tokens/'.$item->id.'/ico/edit?page=all') }}" title="Edit Token"><button class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
