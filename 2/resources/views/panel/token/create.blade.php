            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="box">
                        ...
                        <form method="POST" action="{{ url('/tokens') }}" accept-charset="UTF-8" enctype="multipart/form-data" style="display:inline">
                            {{ csrf_field() }}
                            <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('img') ? 'has-error' : ''}}">
                                ...
                                <input class="form-control" name="img" type="file" id="img" value="{{ isset($token->img) ? $token->img : ''}}" required>
                                {!! $errors->first('img', '<p class="help-block">:message</p>') !!}
                            </div>
                            <div class="form-group {{ $errors->has('decimals') ? 'has-error' : ''}}">
                                <label for="decimals" class="control-label">{{ 'Decimals' }}</label>
                                <input class="form-control" name="decimals" type="number" maxlenght="2" id="decimals" value="{{ isset($token->decimals) ? $token->decimals : ''}}" disabled required>
